...
namespace Ninject.Injection.Expressions
{
	...
	/// </summary>
	public class ExpressionVoidMethodInjector : ExpressionMethodInjectorBase<Action<object, object[]>>
	{
		/// <summary>
		/// Initializes a new instance of the <see cref="ExpressionVoidMethodInjector"/> class.
		/// </summary>
