...
namespace Ninject.Infrastructure.Language
{
    ...
    internal static class ExtensionsForIEnumerable
    {
        ...
        {
            var enumerable = typeof(Enumerable).GetTypeInfo();
            Cast = enumerable.GetMethod(nameof(Cast));
            ToArray = enumerable.GetMethod(nameof(ToArray));
            ToList = enumerable.GetMethod(nameof(ToList));
        }
